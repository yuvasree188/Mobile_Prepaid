...
document.addEventListener("DOMContentLoaded", function () {
    let plans = [
        { name: "Basic Plan", price: 199, validity: "30 Days", dataBenefits: "nil", status: "active" },
        { name: "Unlimited Plan", price: 399, validity: "60 Days", dataBenefits: "1.5GB/Day", status: "active" },
        { name: "Data Booster Plan", price: 599, validity: "90 Days", dataBenefits: "4GB Total", status: "inactive" }
    ];
